...
set autoread
" 編集中でもその他のファイルを開けるようにする
set hidden
" 入力中のコマンドをステータスに表示する
set showcmd
" undoファイルの場所
set undodir=$HOME/undoa
...
"
" deinパス設定
let s:dein_dir = fnamemodify($HOME . '/dein', ':p')
...
call dein#add('vim-scripts/DoxygenToolkit.vim.git')
